...
<body>
	...
	<br>
	<button id="btn11">/ex44/sub03 post form -> obj -> json</button>
...
/* 
*	css 체크박스(boolean) 값을 출력하는 코드 :checked
*   자바스크립트 배열 값을 출력하는 코드 querySelectorAll
*	자바스크립트 향상 for문 for of
*/
