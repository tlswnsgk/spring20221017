...
<body>
	...
	<br>
	<button id="btn4">/ex45/sub04 응답 w/header Your-Header:Your_Value</button>
	<br>
	...
	<br>
	<button id="btn8">/ex45/sub08 응답 본문 json date,datetime</button>
	<br>
	<button id="btn9">/ex45/sub09 응답 본문 json bean 안에 bean </button>
