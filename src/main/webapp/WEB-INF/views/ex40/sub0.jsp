...
<body>
	...
	<button id="btn4">/ex40/sub04 get 방식 fetch</button>
	<br>
	<%-- #btn5 /ex40/sub04 post 방식 fetch 요청 --%>
	<button id="btn5">/ex40/sub04 post 방식 fetch</button>
	<br>
		<%-- #btn5 /ex40/sub04 put 방식 fetch 요청 --%>
	
	<button id="btn6">/ex40/sub04 put 방식 fetch 요청</button>
	<br>
		<%-- #btn5 /ex40/sub04 delete 방식 fetch 요청 --%>
	
	<button id="btn7">/ex40/sub04/ delete 방식 fetch 요청</button>
	
	<br>
	<button id="btn8">/ex40/sub05 get(R) 방식</button>
	<br>
	<button id="btn9">/ex40/sub05 post(C) 방식</button>
	<br>
	<button id="btn10">/ex40/sub05 put(U) 방식</button>
	<br>
	<button id="btn11">/ex40/sub05 delete(D) 방식</button>
